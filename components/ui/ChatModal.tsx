...
export const ChatModal: React.FC<ChatModalProps> = ({
  ...
  useEffect(() => {
    ...
    if (conversationId) {
      ...
      // Create new conversation if we have a receiver ID
      setIsCreating(true);
  ...
  }, [isOpen, conversationId, initialReceiverId, conversations, startNewConversation, initialListingId, initialMessage]);
